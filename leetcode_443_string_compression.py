...
#
#     for c in seen:
#         result_tupple.append((c,chars.count(c)))
#
#     for element in result_tupple:
#         char = element[0]
#         count = element[1]
#
#         result_string = result_string + str(char) + str(count)
#
...
#
#     for c in seen:
#         res(ult_list.append(c)
#         if chars.count(c) > 1:
#             result_list.append(str(chars.count(c)))
#
#     chars[:] = result_list
#
